...
<body>
  ...
  <p class="status">✅ Activated – Zero Auth</p>
  <p>Proxy running at <code>${baseUrl}</code></p>
  <div class="endpoints">
    <h2>Proxy Endpoints</h2>
    <ul>
      <li><strong>M3U8 Proxy</strong><br><code>${baseUrl}/proxy/playlist.m3u8?url=ENCODED_STREAM_URL</code></li>
      <li><strong>Segment Proxy</strong><br><code>${baseUrl}/proxy/segment?url=ENCODED_SEGMENT_URL</code></li>
    </ul>
    <h2>Player / Embed / JSON</h2>
    <ul>
      <li><strong>Player</strong><br><code>${baseUrl}/player?video=ENCODED_STREAM_URL</code></li>
      <li><strong>Embed</strong><br><code>${baseUrl}/embed?video=ENCODED_STREAM_URL</code></li>
      <li><strong>JSON Playback</strong><br><code>${baseUrl}/playback.json?video=ENCODED_STREAM_URL</code></li>
    </ul>
    <h2>Share</h2>
    <ul>
      <li><strong>Get share links</strong><br><code>${baseUrl}/share?video=ENCODED_STREAM_URL</code></li>
    </ul>
